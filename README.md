...
calibration sources, and switches to control the components through which the RF signal flows. See below
![Preselector Diagram](/docs/img/preselector.png?raw=true)
