...
class TestWebRelayPreselector(unittest.TestCase):
    ...
    def test_empty_valid_frequency_low_passband(self):
        ...
        self.assertEqual(
            self.preselector.get_frequency_low_passband(0),
            self.preselector.get_frequency_low_passband(1),
        )
    ...
    def test_valid_get_frequency_high_passband(self):
        ...
        self.assertEqual(
            self.preselector.get_frequency_high_passband(0),
    ...
    def test_valid_get_frequency_low_stopband(self):
        ...
        self.assertEqual(
            self.preselector.get_frequency_low_stopband(0),
            self.preselector.get_frequency_low_stopband(1),
        )
    ...
    def test_valid_get_frequency_high_stopband(self):
        ...
        self.assertEqual(
            self.preselector.get_frequency_high_stopband(0),
